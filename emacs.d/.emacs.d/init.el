...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rust-mode javadoc-lookup company-arduino arduino-mode plantuml-mode jazz-theme monokai-theme shoes-off auto-complete-clang auto-compile ac-ispell slime-company slime spotify highlight-numbers company-quickhelp pos-tip zenburn-theme yasnippet yaml-mode wttrin window-numbering which-key web-mode wcheck-mode wc-mode syslog-mode spaceline solarized-theme smartparens rainbow-delimiters python-mode popwin pdf-tools ox-reveal org-bullets names multiple-cursors minimap markdown-mode magit latex-unicode-math-mode latex-math-preview latex-extra iedit htmlize hlinum highlight helm-swoop helm-smex helm-ls-git helm-fuzzier helm-flx helm-descbinds helm-dash gnuplot-mode gnuplot focus flycheck-irony fix-word expand-region direx dash-at-point csharp-mode company-irony-c-headers company-irony calfw bm blackboard-theme beacon anzu ace-jump-mode)))
